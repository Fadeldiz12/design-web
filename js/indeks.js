 ...
 function showPopups() {
  ...
  }, getRandomTime(1, 2) * 1000); // Mengubah detik menjadi milidetik dengan rentang 1-10 detik
}
...
function createPopup(container) {
  ...
  popup.innerHTML = `
    <h2>Special Offer!</h2>
    <p>Don't miss out on our exclusive deals. Click <a href="#">here</a> to learn more.</p>
    <button onclick="closePopup('${popup.id}')">Close</button>
  `;
